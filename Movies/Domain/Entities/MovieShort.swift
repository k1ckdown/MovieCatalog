...
extension MovieShort {
    ...
    static let mockedMovie = MovieShort(
        ...
        country: "США",
        genres: [
            .init(id: UUID().uuidString, name: "военный"),
            .init(id: UUID().uuidString, name: "история"),
            .init(id: UUID().uuidString, name: "драма"),
            .init(id: UUID().uuidString, name: "биография")
        ],
        reviews: []
    )
}
